...
@PXAStyler(properties = {
        ...
        @PXAProperty(name = "border-top", syntax = "<width> || <border-style> || <paint>"),
        @PXAProperty(name = "border-right", syntax = "<width> || <border-style> || <paint>"),
        @PXAProperty(name = "border-bottom", syntax = "<width> || <border-style> || <paint>"),
        @PXAProperty(name = "border-left", syntax = "<width> || <border-style> || <paint>"),
        ...
        @PXAProperty(name = "border-top-width", syntax = "<length>"),
        @PXAProperty(name = "border-right-width", syntax = "<length>"),
        @PXAProperty(name = "border-bottom-width", syntax = "<length>"),
        @PXAProperty(name = "border-left-width", syntax = "<length>"),
        @PXAProperty(name = "border-color", syntax = "<paint>{1,4}"),
        @PXAProperty(name = "border-top-color", syntax = "<paint>"),
        @PXAProperty(name = "border-right-color", syntax = "<paint>"),
        @PXAProperty(name = "border-bottom-color", syntax = "<paint>"),
        @PXAProperty(name = "border-left-color", syntax = "<paint>"),
        @PXAProperty(name = "border-style", syntax = "<border-style>{1,4}"),
        @PXAProperty(name = "border-top-style", syntax = "<border-style>"),
        @PXAProperty(name = "border-right-style", syntax = "<border-style>"),
        @PXAProperty(name = "border-bottom-style", syntax = "<border-style>"),
        @PXAProperty(name = "border-left-style", syntax = "<border-style>"), })
