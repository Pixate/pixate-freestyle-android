...
/**
 * Virtual adapter for {@link ActionBar} split background.
 * 
 * <pre>
 * <code>
 *   - split
 ...
 * </pre>
 * 
 * For example, setting the split background for an {@link ActionBar} is done
 * like this:
 * 
 * <pre>
 * action-bar split {
 *   background-image: url(split_bg.svg);
 * }
 * </pre>
 * 
 * @author Shalom Gibly
 */
public class PXVirtualActionBarSplitAdapter extends PXVirtualChildAdapter {

    private static String ELEMENT_NAME = "split";
    private static PXVirtualActionBarSplitAdapter instance;

    /**
     * Returns a singleton instance of this class.
     * 
     * @return An instance of {@link PXVirtualActionBarSplitAdapter}
     */
    public static PXVirtualActionBarSplitAdapter getInstance() {
        synchronized (PXVirtualActionBarSplitAdapter.class) {
            if (instance == null) {
                instance = new PXVirtualActionBarSplitAdapter();
            }
        }
        return instance;
    }
    ...
    private void setBackgroundICS(PXStylerContext context, ActionBar actionBar, RectF bounds) {
        actionBar.setSplitBackgroundDrawable(PXDrawableUtil.createDrawable(bounds,
